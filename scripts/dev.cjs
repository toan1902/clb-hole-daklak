...
http.createServer(async(req,res)=>{try{
  ...
  if(!/^\/(?:index\.html|doanh-nghiep\.html|tin-(?:tuc|chi-tiet)\.html|stc-config\.js|anh-giao-luu-[12]\.jpg|admin\/(?:index\.html|app\.js|style\.css)|assets\/[a-z0-9.-]+)$/.test(name)){res.writeHead(404);return res.end('Not found')}
