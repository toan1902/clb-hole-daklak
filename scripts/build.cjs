...
for(const file of ['index.html','tin-chi-tiet.html','tin-tuc.html','stc-config.js','anh-giao-luu-1.jpg','anh-giao-luu-2.jpg'])fs.copyFileSync(path.join(root,file),path.join(out,file));
